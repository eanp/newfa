            ...
            <Col md={3} lg={3} xl={3} className="aside sidebar d-none d-sm-block mt-4">
                <div className="card p-4" style={{ borderRadius: '25px' }}>
                    <Nav navbar>
                        ...
                        <NavItem>
                            <Link to='/adminresto/items/' className='nav-link text-dark text-center'><h6>Dashboard</h6></Link>
                        </NavItem>
                        <NavItem>
                            <Link to='/adminresto/items/' className='nav-link text-dark text-center'><h6>Items</h6></Link>
                        </NavItem>
                        ...
                        <NavItem>
                            <Link to='/adminresto/' className='nav-link text-dark text-center'><h6>My Profile</h6></Link>
                        </NavItem>
                        <NavItem>
                            <Link to='/adminresto/' className='nav-link text-dark text-center'><h6>Edit</h6></Link>
                        </NavItem>
